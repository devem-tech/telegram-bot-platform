...
import (
	...
	"github.com/devem-tech/telegram-bot-platform/mappers"
	"github.com/devem-tech/telegram-bot-platform/opt"
	"github.com/devem-tech/telegram-bot-platform/slices"
)

var (
	chatAction = mappers.MustMap(map[string]ChatAction{
		tgbotapi.ChatTyping:      ChatActionTyping,
		tgbotapi.ChatUploadPhoto: ChatActionUploadPhoto,
		tgbotapi.ChatUploadVideo: ChatActionUploadVideo,
	})

	parseMode = mappers.MustMap(map[string]ParseMode{
		tgbotapi.ModeMarkdownV2: ParseModeMarkdownV2,
	})
)
